...
})({"4FNZU":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "e0a585a4bb0cf892";
...
function update() {
    ...
    for(let i = 0; i < todos.length; i += 1){
        htmlstring.push(`<li class='border rounded my-2 px-2 py-1 w-64 hover:bg-gray-200' onclick='rem(${i})'>${todos[i]}</li>`);
...
},{}]},["4FNZU","igcvL"], "igcvL", "parcelRequire94c2")

//# sourceMappingURL=index.bb0cf892.js.map
